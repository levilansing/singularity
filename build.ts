...
// Run CSV → JSON conversion before building
console.log("📊 Converting predictions CSV → JSON...");
const csvConvert = Bun.spawnSync(["bun", "scripts/convert-csv.ts"], { cwd: process.cwd(), stdout: "inherit", stderr: "inherit" });
if (csvConvert.exitCode !== 0) {
